...
public class V2DieselEngine implements EngineStrategy {

    private static final int torque = 320;
    private static final int fuelTankCapacity = 60;
    private static final int mileage = 20;
    private static final String engineName = "V2 Diesel";
